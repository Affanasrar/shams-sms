...
export function EnrollmentTable({ data }: EnrollmentTableProps) {
  const columns: ColumnDef<EnrollmentRow, string | Date>[] = [
    {
      accessorKey: "studentId",
      header: "Student ID",
      cell: info => <span className="font-mono text-xs text-blue-600 font-medium">{String(info.getValue())}</span>,
    },
    {
    ...
    },
    {
      ...
      cell: info => (
        <div className="text-gray-600">
          <div className="font-medium text-gray-900">{String(info.getValue())}</div>
    ...
    },
    {
      ...
      cell: info => (
        <EnrollmentRowActions
          enrollmentId={String(info.getValue())}
