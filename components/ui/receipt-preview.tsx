...
export function ReceiptPreview({
 ...
 <Card className="p-8 max-w-md bg-card">
 {/* Header */}
 ...
 <span className="text-emerald-600 dark:text-emerald-300 font-medium">{formatCurrency(paidAmount)}</span>
 </div>
 <div className="flex justify-between">
 <span className="text-muted-foreground">Due Amount:</span>
 <span className="text-red-600 dark:text-red-300 font-medium">{formatCurrency(dueAmount)}</span>
 </div>
 </div>
