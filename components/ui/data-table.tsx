...
export function DataTable<TData, TValue>({
 ...
 className="max-w-sm rounded-xl border border-border bg-card "
 />
 )}
 ...
 <TableHead key={header.id} className="px-5 py-3 text-foreground font-semibold">
 ...
 <TableCell key={cell.id} className="px-5 py-3.5 text-foreground ">
 ...
 <div>
 Showing <span className="font-semibold text-foreground ">{startRowIndex}</span> to{' '}
 <span className="font-semibold text-foreground ">{endRowIndex}</span> of{' '}
 <span className="font-semibold text-foreground ">{totalFilteredRows}</span> entries
 </div>
 ...
 className="rounded-lg border border-border bg-card px-2 py-1 text-xs text-foreground outline-none"
 >
 {[25, 50, 100].map((size) => (
