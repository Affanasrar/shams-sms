...
function SummaryCard({ label, value, icon, suffix }: ReceptionistSummaryItem) {
 return (
 <div className="flex h-full min-h-32 flex-col justify-between rounded-3xl border border-white/10 bg-card/8 p-5 backdrop-blur">
 <div className="flex items-center justify-between gap-3">
 <p className="min-w-0 text-xs font-semibold uppercase tracking-[0.18em] text-white/55">{label}</p>
 <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-card/10 text-white">
 {icon}
 </span>
 </div>
