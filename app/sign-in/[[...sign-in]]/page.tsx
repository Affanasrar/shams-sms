...
export default function Page() {
 ...
 <div className="mt-8 rounded-2xl border border-white/10 bg-card/10 p-4 text-sm text-slate-200">
 ...
 <div className="flex flex-1 items-center justify-center bg-card p-4 sm:p-8">
