...
export default async function FeesReportsPage(props: ReportsPageProps) {
 ...
 className="group flex items-center justify-center w-12 h-12 bg-card border border-border rounded-2xl shadow-sm hover:shadow-md transition-all duration-200"
 >
 <ArrowLeft size={20} className="text-muted-foreground group-hover:text-foreground dark:group-hover:text-white transition-colors" />
 </Link>
 <div>
 <h1 className="text-3xl font-bold text-foreground ">
 Fees Reports
 </h1>
 <p className="text-muted-foreground mt-1">Generate comprehensive PDF reports for fees management</p>
 </div>
 </div>
 <DateRangePicker />
 </div>
 ...
 <div className="bg-card rounded-3xl p-6 shadow-sm border border-border transition-all">
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-muted-foreground ">Total Billed Records</p>
 <p className="text-2xl font-bold text-foreground mt-1">{fees.length}</p>
 </div>
 ...
 <h2 className="text-lg font-bold text-foreground mb-4">Fee Records in Selected Range</h2>
 ...
 <div className="p-3 bg-card/15 backdrop-blur-md rounded-2xl">
