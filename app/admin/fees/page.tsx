...
export default async function FeesPage(props: Props) {
 ...
 {/* Header Banner */}
 <div className="rounded-3xl border border-border bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 p-6 text-white shadow-2xl md:p-8">
 ...
 className="inline-flex items-center gap-2 rounded-2xl bg-card/10 border border-white/20 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-card/20"
 >
 ...
 className="w-full rounded-2xl border border-border bg-card pl-10 pr-4 py-2.5 text-xs text-foreground outline-none transition focus:border-indigo-500"
 />
 </form>
 </div>
 ...
 <p className="text-base font-semibold text-foreground ">No fee records found</p>
