...
export function EditStudentForm({ student }: EditStudentProps) {
 ...
 return (
 <form action={formAction} className="space-y-6 bg-card p-8 rounded-xl border shadow-sm">
 ...
 {state?.error && (
 <div className="rounded-md bg-red-50 dark:bg-red-950/40 px-4 py-3 text-sm text-red-700 dark:text-red-300 border border-red-100 dark:border-red-900/50">
 {state.error}
 </div>
 )}
