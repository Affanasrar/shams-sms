...
export function ReportFormatConfig({ formats: initialFormats }: Props) {
 ...
 <div>
 <label className="block text-sm font-medium text-foreground mb-2">Header Text</label>
 <input
 type="text"
 ...
 <div className="mt-6">
 <h4 className="text-md font-medium text-foreground mb-3">Margins (points)</h4>
 ...
 {/* Title */}
 <div>
 <h4 className="text-md font-medium text-foreground mb-3">Title</h4>
 ...
 {/* Subtitle */}
 <div>
 <h4 className="text-md font-medium text-foreground mb-3">Subtitle</h4>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
 <div>
 <label className="block text-sm font-medium text-foreground mb-1">Font Family</label>
 <select
 ...
 {/* Body */}
 <div>
 <h4 className="text-md font-medium text-foreground mb-3">Body Text</h4>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
 <div>
 <label className="block text-sm font-medium text-foreground mb-1">Font Family</label>
 <select
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Logo</span>
 </label>
 <label className="flex items-center">
 <input
 type="checkbox"
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Generated Date</span>
 </label>
 <label className="flex items-center">
 <input
 type="checkbox"
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Page Numbers</span>
 </label>
 </div>

 {/* Institution Info */}
 <div className="border-t pt-4">
 <h4 className="text-md font-medium text-foreground mb-3">Institution Information</h4>
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Institution Info</span>
 </label>
 ...
 <div className="border-t pt-4">
 <h4 className="text-md font-medium text-foreground mb-3">Report-Specific Features</h4>
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Student Details</span>
 </label>
 <label className="flex items-center">
 <input
 type="checkbox"
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Payment History</span>
 </label>
 </>
 )}
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Fee Breakdown</span>
 </label>
 <label className="flex items-center">
 <input
 type="checkbox"
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Payment Timeline</span>
 </label>
 </>
 )}
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Student List</span>
 </label>
 )}
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Charts</span>
 </label>
 <label className="flex items-center">
 <input
 type="checkbox"
 ...
 className="rounded border-gray-300 text-purple-600 dark:text-purple-300 focus:ring-purple-500"
 />
 <span className="ml-2 text-sm text-foreground">Show Monthly Trends</span>
 </label>
 </>
 )}
 </div>
 ...
 message.includes('✅')
 ? 'bg-green-50 dark:bg-green-950/40 text-green-800 dark:text-green-300 border border-green-200 dark:border-green-900/50'
