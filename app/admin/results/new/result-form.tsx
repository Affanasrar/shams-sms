...
export function ResultForm({ students }: { students: any[] }) {
 ...
 className="w-full border p-2 rounded bg-card disabled:bg-muted"
 >
 <option value="">
 ...
 {/* 3. Marks Obtained */}
 <div>
 <label className="block text-sm font-medium text-foreground mb-1">Marks Obtained</label>
 <input 
 ...
 <select name="grade" className="w-full border p-2 rounded bg-card">
 <option>A+</option>
 <option>A</option>
 <option>B</option>
 <option>C</option>
 ...
 {/* 6. Attempt Number */}
 <div>
 <label className="block text-sm font-medium text-foreground mb-1">Attempt #</label>
 <input 
 ...
 {state?.error && (
 <div className="p-3 bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-300 text-sm rounded border border-red-200 dark:border-red-900/50">
 ⚠️ {state.error}
 </div>
 )}
