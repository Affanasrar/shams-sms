...
export function AttendanceViewer({ classId, adminId, enrollments }: Props) {
 ...
 switch (status) {
 case 'PRESENT': return 'bg-green-100 text-green-800 dark:text-green-300'
 case 'ABSENT': return 'bg-red-100 text-red-800 dark:text-red-300'
 case 'LATE': return 'bg-yellow-100 text-yellow-800 dark:text-yellow-300'
 case 'LEAVE': return 'bg-blue-100 text-blue-800 dark:text-blue-300'
 ...
 const colors = {
 PRESENT: 'bg-green-100 text-green-800 dark:text-green-300',
 ABSENT: 'bg-red-100 text-red-800 dark:text-red-300',
 LATE: 'bg-yellow-100 text-yellow-800 dark:text-yellow-300',
 LEAVE: 'bg-blue-100 text-blue-800 dark:text-blue-300'
 }
 ...
 <label className="font-medium text-foreground">Select Date:</label>
 </div>
 <input
 type="date"
 value={selectedDate}
 ...
 <div className="flex items-center gap-2 ml-4 px-4 py-2 bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-900/50 rounded-lg">
 ...
 {/* Message */}
 {message && (
 <div className={`p-4 rounded-lg border ${message.type === 'success' ? 'bg-green-50 dark:bg-green-950/40 border-green-200 dark:border-green-900/50 text-green-800 dark:text-green-300' : 'bg-red-50 dark:bg-red-950/40 border-red-200 dark:border-red-900/50 text-red-800 dark:text-red-300'}`}>
 <div className="flex items-center gap-2">
 ...
 <div className="flex items-center gap-2 px-4 py-2 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/50 rounded-lg">
 <CheckCircle2 size={18} className="text-blue-600 dark:text-blue-300 animate-pulse" />
 <span className="text-sm font-semibold text-blue-700 dark:text-blue-300">Updated</span>
 </div>
 )}
 </div>
 </div>
 ...
 return (
 <div key={enrollment.student.id} className="p-4 hover:bg-muted transition">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-3">
 <div className="h-10 w-10 rounded-full bg-blue-100 text-blue-600 dark:text-blue-300 flex items-center justify-center font-bold text-sm">
 ...
 className="text-blue-600 dark:text-blue-300 hover:text-blue-800 dark:text-blue-300 p-1"
