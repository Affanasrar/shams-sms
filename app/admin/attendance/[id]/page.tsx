      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-500">
            {classData.slot.days} • {new Date(classData.slot.startTime).toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true, timeZone: 'Asia/Karachi' })} • {classData.slot.room.name}
          </p>
        </div>
      </div>
