...
export function EnrollmentFilters({ courses, slots }: Props) {
 ...
 <Filter size={16} className="text-indigo-600 dark:text-indigo-300" />
 Filter enrollments
 </div>
 ...
 className="w-full rounded-2xl border border-border bg-card/90 py-2.5 pl-10 pr-3 text-sm text-foreground shadow-sm transition focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
 />
 </div>
 ...
 className="w-full rounded-2xl border border-border bg-card/90 px-3 py-2.5 text-sm text-foreground shadow-sm transition focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
 >
 ...
 className="inline-flex items-center justify-center gap-2 rounded-2xl border border-border bg-muted px-3 py-2.5 text-sm font-semibold text-foreground transition hover:bg-muted"
 >
 <X size={14} />
 Clear
 </button>
