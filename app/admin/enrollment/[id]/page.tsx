  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(99,102,241,0.16),transparent_28%),radial-gradient(circle_at_bottom_right,rgba(56,189,248,0.14),transparent_34%)] px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        {/* ── Page header card ── */}
        <div className="mb-8 rounded-[32px] border border-slate-200/80 bg-white/80 p-6 shadow-[0_24px_70px_-28px_rgba(15,23,42,0.32)] backdrop-blur-xl dark:border-slate-700/80 dark:bg-slate-900/80 sm:p-8">
          <Link
            href="/admin/enrollment"
            className="mb-6 inline-flex items-center gap-2 text-sm font-semibold text-indigo-600 transition hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300"
          >
            <ArrowLeft size={18} />
            Back to Enrollments
          </Link>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-sm font-medium text-indigo-700 dark:border-indigo-800 dark:bg-indigo-900/40 dark:text-indigo-300">
                <BookOpen size={16} />
                Edit enrollment
              </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400">
              <p className="font-semibold text-slate-900 dark:text-slate-100">4 guided steps</p>
        ...
        {/* ── Form card ── */}
        <div className="overflow-hidden rounded-[32px] border border-slate-200/80 bg-white/90 shadow-[0_24px_70px_-28px_rgba(15,23,42,0.32)] dark:border-slate-700/80 dark:bg-slate-900/90">
        ...
        {/* ── Help note ── */}
        <div className="mt-8 rounded-[24px] border border-slate-200/80 bg-white/80 p-4 text-sm text-slate-600 shadow-[0_20px_60px_-28px_rgba(15,23,42,0.24)] backdrop-blur-xl dark:border-slate-700/80 dark:bg-slate-900/80 dark:text-slate-400">
          <span className="font-semibold text-slate-900 dark:text-slate-100">Tip:</span> Backdating the enrollment date will automatically generate any missing monthly fee records for the student.
        </div>
      </div>
    </div>
  )
