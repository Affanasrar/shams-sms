...
export default async function EditEnrollmentPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <Link href="/admin/enrollment" className="rounded-full border border-white/15 p-2 transition hover:bg-card/10 hover:text-white">
 <ArrowLeft size={18} />
 </Link>
 ...
 <div>
 <h2 className="text-xl font-semibold tracking-tight text-foreground">Edit enrollment details</h2>
 <p className="mt-1 text-sm text-muted-foreground">Change the assigned course slot or enrollment date.</p>
 </div>
 ...
 <div>
 <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Joining date</p>
 <p className="font-semibold text-foreground">{enrollment.joiningDate.toISOString().slice(0, 10)}</p>
 </div>
 </div>
 </div>
 ...
 <p className="font-semibold text-foreground">{enrollment.courseOnSlot.slot.room.name}</p>
 </div>
 </div>
 </div>
 ...
 <div>
 <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Current slot label</p>
 <p className="font-semibold text-foreground">{enrollment.courseOnSlot.slot.days}</p>
 </div>
 </div>
 </div>
