...
export default async function DroppedStudentsPage(props: Props) {
 ...
 <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Total Dropped</p>
 <p className="text-3xl font-bold text-foreground ">{stats._count}</p>
 <p className="text-xs text-muted-foreground mt-2">Across all courses</p>
 </div>

 <div className="card-surface p-5 ">
 <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">📅 Duration Drops</p>
 <p className="text-3xl font-bold text-amber-600 dark:text-amber-400">{durationDropCount}</p>
 <p className="text-xs text-muted-foreground mt-2">Course ended naturally</p>
 </div>

 <div className="card-surface p-5 ">
 <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">🚫 Admin Drops</p>
 <p className="text-3xl font-bold text-rose-600 dark:text-rose-400">{adminDropCount}</p>
 <p className="text-xs text-muted-foreground mt-2">Manually dropped</p>
 </div>

 <div className="card-surface p-5 ">
 <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Courses Affected</p>
 <p className="text-3xl font-bold text-foreground ">{droppedByCourse.length}</p>
 <p className="text-xs text-muted-foreground mt-2">With dropped students</p>
 </div>

 <div className="card-surface p-5 ">
 <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Filtered Results</p>
 ...
 Showing <span className="font-semibold text-foreground ">{rows.length}</span> dropped student
 {rows.length !== 1 ? 's' : ''}
 </p>
 ...
 <p className="text-foreground font-medium">No dropped students found</p>
