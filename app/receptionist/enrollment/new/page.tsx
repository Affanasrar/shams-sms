...
export default async function NewReceptionistEnrollmentPage() {
 ...
 <div className="mx-auto max-w-4xl overflow-hidden rounded-[2rem] border border-border bg-card shadow-sm">
 <div className="border-b border-border bg-muted/80 px-6 py-4">
 <Link href="/receptionist" className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:bg-muted">
 <ArrowLeft size={16} />
 Back to dashboard
 </Link>
 </div>
 ...
 <div className="rounded-[1.75rem] border border-border bg-muted p-4 text-sm text-muted-foreground shadow-sm">
